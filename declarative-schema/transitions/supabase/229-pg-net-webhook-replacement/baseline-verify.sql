select jsonb_build_object(
          ...
          and (
        pg_get_functiondef('public.notify_transition_229()'::regprocedure) ilike '%transition-229-v1%'
and pg_get_functiondef('public.notify_transition_229()'::regprocedure) ilike '%1000%'
and exists (
