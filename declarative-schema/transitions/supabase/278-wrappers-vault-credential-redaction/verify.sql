-- Invariant: endpoint changes preserve the same encrypted credential reference.
  ...
  'valid',
    ...
    and exists (
      ...
      where server.srvname = 'transition_vault_server_278'
        ...
        and option.option_value = 'https://vault-wrapper.invalid/v2'
    )
    and exists (
      select 1
      from pg_foreign_server server,
      ...
      where server.srvname = 'transition_vault_server_278'
        ...
        and secret.decrypted_secret = 'PGDELTA_WRAPPER_VAULT_SECRET_278'
    )
