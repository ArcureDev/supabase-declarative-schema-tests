...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  process.exitCode = runDeclarativeSchema(loadRunnerConfig(scriptDirectory, args), args);
}

export {failedCaseNumbersFromReport, parseCaseSelection} from "./runner/selection.mts";