# Case: 476-range-rename

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `range-rename`
- Catalogue atoms: `PG-CAT-TYP-04::range.rename`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-04::range.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818133356_rename_ambiguity_baseline.sql`
...
### `20260818133437_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.2s`
<!-- declarative-schema-command-result case="476-range-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="476-range-rename" engine="next" command="sync-verification" status="OK" -->
