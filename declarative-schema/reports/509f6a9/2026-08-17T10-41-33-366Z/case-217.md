...
### `20260817192956_217_cross_kind_dependency_ordering_baseline.sql`
...
### `20260817193056_declarative_sync.sql`
...
Applying migration 20260817192956_217_cross_kind_dependency_ordering_baseline.sql...
Initialising schema...
+ ulimit -n
+ '[' -n '' ']'
+ export ERL_CRASH_DUMP=/tmp/erl_crash.dump
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\217-cross-kind-dependency-ordering\supabase\migrations\20260817193056_declarative_sync.sql
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\217-cross-kind-dependency-ordering-legacy\supabase\migrations\20260817193213_217_cross_kind_dependency_ordering_baseline.sql
...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\217-cross-kind-dependency-ordering-legacy\supabase\.temp\pgdelta\debug\20260817-193213-apply-error
...
```text
The declarative baseline failed, so the topological creation across functions, aggregate, views, materialized view, and trigger transition was skipped.
```
