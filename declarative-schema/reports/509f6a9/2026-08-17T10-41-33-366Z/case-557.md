# Case: 557-publication-rename

- Scenario pack: `Publications and logical replication catalogue scenarios` / `publication-rename`
- Catalogue atoms: `PG-CAT-PUB-01::publication.rename`

## Baseline state A

```sql
-- Covers PG-CAT-PUB-01::publication.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818172603_rename_ambiguity_baseline.sql`
...
### `20260818172654_declarative_sync.sql`
...
- Result: **OK**
- Duration: `50.0s`
<!-- declarative-schema-command-result case="557-publication-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="557-publication-rename" engine="next" command="sync-verification" status="OK" -->
