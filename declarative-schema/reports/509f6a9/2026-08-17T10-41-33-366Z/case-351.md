...
### `20260818062421_351_compression_baseline.sql`
...
Applying migration 20260818062421_351_compression_baseline.sql...
Initialising schema...
+ ulimit -n
+ '[' -n '' ']'
+ export ERL_CRASH_DUMP=/tmp/erl_crash.dump
...
No migration SQL was generated.
```
<!-- declarative-schema-command-result case="351-compression" engine="next" command="sync" status="ERROR" -->
...
```
<!-- declarative-schema-command-result case="351-compression" engine="next" command="sync-verification" status="ERROR" -->
...
ALTER TABLE public.catalogue_compression
  ADD CONSTRAINT catalogue_compression_pkey PRIMARY KEY (id);

GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.catalogue_compression TO anon;

GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.catalogue_compression TO authenticated;

GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.catalogue_compression TO service_role;
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\351-compression-legacy\supabase\migrations\20260818072714_351_compression_baseline.sql
...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\351-compression-legacy\supabase\.temp\pgdelta\debug\20260818-072714-apply-error
...
```text
The declarative baseline failed, so the apply compression with a native in-place operation transition was skipped.
```
<!-- declarative-schema-command-result case="351-compression" engine="legacy" command="sync" status="ERROR" -->
