...
pg-delta next diagnostic: origin=export code=unmodeled_kind message=1 unmodeled "text search dictionary" object not managed by this engine (e.g. fixture_simple_dict) — v1 detects but does not model this kind; keep its DDL in _custom/ so re-exports preserve it and the shadow can elaborate dependents, and deliver it to targets via your migration channel
...
```
<!-- declarative-schema-command-result case="161-text-search-dictionary" engine="next" command="generate" status="WARNING" -->
...
- Result: **OK**
- Duration: `39.8s`
<!-- declarative-schema-command-result case="161-text-search-dictionary" engine="legacy" command="generate" status="OK" -->
...
- Result: **OK**
- Duration: `50.9s`
<!-- declarative-schema-command-result case="161-text-search-dictionary" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `41.1s`
<!-- declarative-schema-command-result case="161-text-search-dictionary" engine="next" command="sync-verification" status="OK" -->
...
- Result: **OK**
- Duration: `23.9s`
<!-- declarative-schema-command-result case="161-text-search-dictionary" engine="legacy" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `22.9s`
<!-- declarative-schema-command-result case="161-text-search-dictionary" engine="legacy" command="sync-verification" status="OK" -->
