# Case: 359-move-sequence

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `move-sequence`
- Catalogue atoms: `PG-CAT-STC-09::move.sequence`

## Baseline state A

```sql
-- Covers PG-CAT-STC-09::move.sequence. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818074841_rename_ambiguity_baseline.sql`
...
### `20260818074921_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.6s`
<!-- declarative-schema-command-result case="359-move-sequence" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="359-move-sequence" engine="next" command="sync-verification" status="OK" -->
