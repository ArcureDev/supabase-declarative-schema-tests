# Case: 494-view-incompatible

- Scenario pack: `Views and materialized views catalogue scenarios` / `view-incompatible`
- Catalogue atoms: `PG-CAT-VIW-02::view.incompatible`
...
### `20260818142317_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\494-view-incompatible\supabase\migrations\20260818142317_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="494-view-incompatible" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="494-view-incompatible" engine="next" command="sync-verification" status="OK" -->
...
### `20260818142435_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\494-view-incompatible-legacy\supabase\migrations\20260818142435_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="494-view-incompatible" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="494-view-incompatible" engine="legacy" command="sync-verification" status="OK" -->
