...
pg-delta next diagnostic: origin=export code=unmodeled_kind message=1 unmodeled "text search configuration" object not managed by this engine (e.g. fixture_mapping_drop) — v1 detects but does not model this kind; keep its DDL in _custom/ so re-exports preserve it and the shadow can elaborate dependents, and deliver it to targets via your migration channel
...
```
<!-- declarative-schema-command-result case="166-text-search-configuration-mapping-drop" engine="next" command="generate" status="WARNING" -->
...
- Result: **OK**
- Duration: `36.2s`
<!-- declarative-schema-command-result case="166-text-search-configuration-mapping-drop" engine="legacy" command="generate" status="OK" -->
...
- Result: **OK**
- Duration: `49.5s`
<!-- declarative-schema-command-result case="166-text-search-configuration-mapping-drop" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `39.9s`
<!-- declarative-schema-command-result case="166-text-search-configuration-mapping-drop" engine="next" command="sync-verification" status="OK" -->
...
- Result: **OK**
- Duration: `22.2s`
<!-- declarative-schema-command-result case="166-text-search-configuration-mapping-drop" engine="legacy" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `22.2s`
<!-- declarative-schema-command-result case="166-text-search-configuration-mapping-drop" engine="legacy" command="sync-verification" status="OK" -->
