...
pg-delta next diagnostic: origin=export code=unmodeled_kind message=1 unmodeled "text search configuration" object not managed by this engine (e.g. fixture_mapping_replace) — v1 detects but does not model this kind; keep its DDL in _custom/ so re-exports preserve it and the shadow can elaborate dependents, and deliver it to targets via your migration channel
...
```
<!-- declarative-schema-command-result case="164-text-search-configuration-mapping-replacement" engine="next" command="generate" status="WARNING" -->
...
- Result: **OK**
- Duration: `36.9s`
<!-- declarative-schema-command-result case="164-text-search-configuration-mapping-replacement" engine="legacy" command="generate" status="OK" -->
...
- Result: **OK**
- Duration: `40.0s`
<!-- declarative-schema-command-result case="164-text-search-configuration-mapping-replacement" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `40.1s`
<!-- declarative-schema-command-result case="164-text-search-configuration-mapping-replacement" engine="next" command="sync-verification" status="OK" -->
...
- Result: **OK**
- Duration: `22.4s`
<!-- declarative-schema-command-result case="164-text-search-configuration-mapping-replacement" engine="legacy" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `22.3s`
<!-- declarative-schema-command-result case="164-text-search-configuration-mapping-replacement" engine="legacy" command="sync-verification" status="OK" -->
