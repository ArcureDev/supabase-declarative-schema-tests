# Case: 483-opclass-create

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `opclass-create`
- Catalogue atoms: `PG-CAT-TYP-07::opclass.create`
...
-- Desired change for opclass.create must be refused, not silently omitted.
```
...
### `20260818135241_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\483-opclass-create\supabase\migrations\20260818135241_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="483-opclass-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="483-opclass-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260818135400_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\483-opclass-create-legacy\supabase\migrations\20260818135400_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="483-opclass-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="483-opclass-create" engine="legacy" command="sync-verification" status="OK" -->
