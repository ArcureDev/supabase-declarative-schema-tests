...
- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `cast-lossy`
- Catalogue atoms: `PG-CAT-STC-04::cast.lossy`

## Baseline state A

```sql
-- Covers PG-CAT-STC-04::cast.lossy. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for cast.lossy must be refused, not silently omitted.
```
...
### `20260818041039_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\327-cast-lossy\supabase\migrations\20260818041039_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="327-cast-lossy" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="327-cast-lossy" engine="next" command="sync-verification" status="OK" -->
...
### `20260818041158_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\327-cast-lossy-legacy\supabase\migrations\20260818041158_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="327-cast-lossy" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="327-cast-lossy" engine="legacy" command="sync-verification" status="OK" -->
