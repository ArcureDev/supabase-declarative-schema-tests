# Case: 247-platform-upgrade-config-drift-no-op

- Coverage: prove repeated local startup and platform configuration leave a converged application declaration and managed identities unchanged
- Requirements: `M3`

## Stop the prior shared runtime (config plane)

- Command: `npx supabase stop --no-backup`
- Result: **OK**
- Duration: `12.8s`

## Start the configured local platform (config plane)

- Command: `npx supabase start --debug`
- Result: **OK**
- Duration: `33.4s`

## Reset platform-managed state (config plane)

- Command: `npx supabase db reset --local --no-seed --debug`
- Result: **OK**
- Duration: `31.5s`

## Apply the application declaration (config plane)

- Command: `npx supabase db schema declarative sync --apply --name config_drift_247 --debug`
- Result: **ERROR**
- Duration: `40.5s`
- Exit code: `1`
...
## Capture managed and application identities (config plane)

- Command: `phase:snapshot`
- Result: **SKIPPED**
- Duration: `0.0s`

```text
Blocked by unsuccessful phase(s): apply.
```

## Repeat startup as a configuration no-op (config plane)

- Command: `phase:restart`
- Result: **SKIPPED**
- Duration: `0.0s`

```text
Blocked by unsuccessful phase(s): snapshot.
```

## Require an empty declarative diff (config plane)

- Command: `phase:converge`
- Result: **SKIPPED**
- Duration: `0.0s`

```text
Blocked by unsuccessful phase(s): restart.
```

## Verify identities and configured database version (config plane)
...
```text
Blocked by unsuccessful phase(s): converge.
```
...
(no output)
```
<!-- declarative-schema-command-result case="247-platform-upgrade-config-drift-no-op" engine="next" command="generate" status="ERROR" -->
<!-- declarative-schema-command-result case="247-platform-upgrade-config-drift-no-op" engine="next" command="sync" status="ERROR" -->
<!-- declarative-schema-command-result case="247-platform-upgrade-config-drift-no-op" engine="next" command="sync-verification" status="ERROR" -->
