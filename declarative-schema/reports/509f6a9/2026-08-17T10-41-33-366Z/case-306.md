# Case: 306-rename-table

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `rename-table`
- Catalogue atoms: `PG-CAT-STC-02::rename.table`

## Baseline state A

```sql
-- Covers PG-CAT-STC-02::rename.table. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818021005_rename_ambiguity_baseline.sql`
...
### `20260818021055_declarative_sync.sql`
...
- Result: **OK**
- Duration: `50.0s`
<!-- declarative-schema-command-result case="306-rename-table" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="306-rename-table" engine="next" command="sync-verification" status="OK" -->
