# Case: 490-view-rename

- Scenario pack: `Views and materialized views catalogue scenarios` / `view-rename`
- Catalogue atoms: `PG-CAT-VIW-01::view.rename`

## Baseline state A

```sql
-- Covers PG-CAT-VIW-01::view.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818141233_rename_ambiguity_baseline.sql`
...
### `20260818141343_declarative_sync.sql`
...
- Result: **OK**
- Duration: `69.4s`
<!-- declarative-schema-command-result case="490-view-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="490-view-rename" engine="next" command="sync-verification" status="OK" -->
