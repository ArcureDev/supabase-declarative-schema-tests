...
### `20260817175744_205_advanced_index_markers_baseline.sql`
...
### `20260817175834_declarative_sync.sql`
...
Applying migration 20260817175744_205_advanced_index_markers_baseline.sql...
Initialising schema...
+ ulimit -n
+ '[' -n '' ']'
+ export ERL_CRASH_DUMP=/tmp/erl_crash.dump
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\205-advanced-index-markers\supabase\migrations\20260817175834_declarative_sync.sql
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\205-advanced-index-markers-legacy\supabase\migrations\20260817180000_205_advanced_index_markers_baseline.sql
...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\205-advanced-index-markers-legacy\supabase\.temp\pgdelta\debug\20260817-180000-apply-error
...
```text
The declarative baseline failed, so the GIN, GiST, SP-GiST, BRIN, pg_trgm, duplicate-equivalent indexes, clustered index, and replica-identity index evolution transition was skipped.
```
