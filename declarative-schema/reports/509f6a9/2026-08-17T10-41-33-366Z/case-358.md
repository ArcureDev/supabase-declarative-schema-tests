# Case: 358-rename-sequence

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `rename-sequence`
- Catalogue atoms: `PG-CAT-STC-09::rename.sequence`

## Baseline state A

```sql
-- Covers PG-CAT-STC-09::rename.sequence. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818074624_rename_ambiguity_baseline.sql`
...
### `20260818074723_declarative_sync.sql`
...
- Result: **OK**
- Duration: `59.5s`
<!-- declarative-schema-command-result case="358-rename-sequence" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="358-rename-sequence" engine="next" command="sync-verification" status="OK" -->
