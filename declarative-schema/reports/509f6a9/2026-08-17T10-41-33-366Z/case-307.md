...
### `20260818021211_rename_ambiguity_baseline.sql`
...
### `20260818021302_declarative_sync.sql`
...
- Result: **OK**
- Duration: `50.5s`
<!-- declarative-schema-command-result case="307-move-table" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="307-move-table" engine="next" command="sync-verification" status="OK" -->
