# Case: 474-composite-rename-attribute

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `composite-rename-attribute`
- Catalogue atoms: `PG-CAT-TYP-03::composite.rename-attribute`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-03::composite.rename-attribute. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818132858_rename_ambiguity_baseline.sql`
...
### `20260818132939_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.2s`
<!-- declarative-schema-command-result case="474-composite-rename-attribute" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="474-composite-rename-attribute" engine="next" command="sync-verification" status="OK" -->
