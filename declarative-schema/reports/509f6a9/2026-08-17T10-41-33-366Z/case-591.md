# Case: 591-boundary-large-object

- Scenario pack: `Explicit PostgreSQL boundaries catalogue scenarios` / `boundary-large-object`
- Catalogue atoms: `PG-CAT-BND-01::boundary.large-object`

## Baseline state A

```sql
-- Covers PG-CAT-BND-01::boundary.large-object. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for boundary.large-object must be refused, not silently omitted.
```
...
### `20260818190131_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\591-boundary-large-object\supabase\migrations\20260818190131_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="591-boundary-large-object" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="591-boundary-large-object" engine="next" command="sync-verification" status="OK" -->
...
### `20260818190251_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\591-boundary-large-object-legacy\supabase\migrations\20260818190251_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="591-boundary-large-object" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="591-boundary-large-object" engine="legacy" command="sync-verification" status="OK" -->
