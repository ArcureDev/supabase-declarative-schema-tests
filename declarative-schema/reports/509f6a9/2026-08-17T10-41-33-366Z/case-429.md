# Case: 429-statistics-drop

- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `statistics-drop`
- Catalogue atoms: `PG-CAT-CIX-08::statistics.drop`
...
### `20260818112051_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\429-statistics-drop\supabase\migrations\20260818112051_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="429-statistics-drop" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="429-statistics-drop" engine="next" command="sync-verification" status="OK" -->
...
### `20260818112219_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\429-statistics-drop-legacy\supabase\migrations\20260818112219_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="429-statistics-drop" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="429-statistics-drop" engine="legacy" command="sync-verification" status="OK" -->
