...
### `20260817181527_212_view_materialized_view_evolution_baseline.sql`
...
### `20260817181607_declarative_sync.sql`
...
Applying migration 20260817181527_212_view_materialized_view_evolution_baseline.sql...
Initialising schema...
+ ulimit -n
+ '[' -n '' ']'
+ export ERL_CRASH_DUMP=/tmp/erl_crash.dump
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\212-view-materialized-view-evolution\supabase\migrations\20260817181607_declarative_sync.sql
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\212-view-materialized-view-evolution-legacy\supabase\migrations\20260817181715_212_view_materialized_view_evolution_baseline.sql
...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\212-view-materialized-view-evolution-legacy\supabase\.temp\pgdelta\debug\20260817-181715-apply-error
...
```text
The declarative baseline failed, so the compatible view replacement and materialized-view rebuild transition was skipped.
```
