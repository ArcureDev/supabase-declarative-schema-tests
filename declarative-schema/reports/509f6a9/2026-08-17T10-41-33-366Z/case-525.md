# Case: 525-event-trigger-rename

- Scenario pack: `Functions, procedures, aggregates, and triggers catalogue scenarios` / `event-trigger-rename`
- Catalogue atoms: `PG-CAT-RTN-07::event-trigger.rename`

## Baseline state A

```sql
-- Covers PG-CAT-RTN-07::event-trigger.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818155427_rename_ambiguity_baseline.sql`
...
### `20260818155508_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.4s`
<!-- declarative-schema-command-result case="525-event-trigger-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="525-event-trigger-rename" engine="next" command="sync-verification" status="OK" -->
