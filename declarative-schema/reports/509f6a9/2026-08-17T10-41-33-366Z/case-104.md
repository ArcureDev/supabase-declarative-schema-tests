...
```sql
{
  ...
  "files": [
    ...
    "public/functions/integer_near_eq.sql",
    "public/schema.sql"
  ]
}
```
...
pg-delta next diagnostic: origin=export code=unmodeled_kind message=1 unmodeled "operator" object not managed by this engine (e.g. @=) — v1 detects but does not model this kind; keep its DDL in _custom/ so re-exports preserve it and the shadow can elaborate dependents, and deliver it to targets via your migration channel
...
```
<!-- declarative-schema-command-result case="104-custom-operator" engine="next" command="generate" status="WARNING" -->
...
- Result: **OK**
- Duration: `57.0s`
<!-- declarative-schema-command-result case="104-custom-operator" engine="legacy" command="generate" status="OK" -->
...
- Result: **OK**
- Duration: `41.3s`
<!-- declarative-schema-command-result case="104-custom-operator" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `42.3s`
<!-- declarative-schema-command-result case="104-custom-operator" engine="next" command="sync-verification" status="OK" -->
...
- Result: **OK**
- Duration: `22.6s`
<!-- declarative-schema-command-result case="104-custom-operator" engine="legacy" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `24.7s`
<!-- declarative-schema-command-result case="104-custom-operator" engine="legacy" command="sync-verification" status="OK" -->
