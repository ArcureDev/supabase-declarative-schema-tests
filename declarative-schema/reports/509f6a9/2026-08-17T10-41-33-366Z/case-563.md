# Case: 563-subscription-redaction

- Scenario pack: `Publications and logical replication catalogue scenarios` / `subscription-redaction`
- Catalogue atoms: `PG-CAT-PUB-03::subscription.redaction`

## Baseline state A

```sql
-- Covers PG-CAT-PUB-03::subscription.redaction. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for subscription.redaction must be refused, not silently omitted.
```
...
### `20260818174306_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\563-subscription-redaction\supabase\migrations\20260818174306_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="563-subscription-redaction" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="563-subscription-redaction" engine="next" command="sync-verification" status="OK" -->
...
### `20260818174426_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\563-subscription-redaction-legacy\supabase\migrations\20260818174426_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="563-subscription-redaction" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="563-subscription-redaction" engine="legacy" command="sync-verification" status="OK" -->
