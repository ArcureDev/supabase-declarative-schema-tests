# Case: 504-routine-extension-language

- Scenario pack: `Functions, procedures, aggregates, and triggers catalogue scenarios` / `routine-extension-language`
- Catalogue atoms: `PG-CAT-RTN-01::routine.extension-language`

## Baseline state A

```sql
-- Covers PG-CAT-RTN-01::routine.extension-language. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for routine.extension-language must be refused, not silently omitted.
```
...
### `20260818145047_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\504-routine-extension-language\supabase\migrations\20260818145047_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="504-routine-extension-language" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="504-routine-extension-language" engine="next" command="sync-verification" status="OK" -->
...
### `20260818145206_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\504-routine-extension-language-legacy\supabase\migrations\20260818145206_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="504-routine-extension-language" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="504-routine-extension-language" engine="legacy" command="sync-verification" status="OK" -->
