# Case: 565-textsearch-mapping

- Scenario pack: `Text search, collations, conversions, and languages catalogue scenarios` / `textsearch-mapping`
- Catalogue atoms: `PG-CAT-FTS-01::textsearch.mapping`

## Baseline state A

```sql
-- Covers PG-CAT-FTS-01::textsearch.mapping. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for textsearch.mapping must be refused, not silently omitted.
```
...
### `20260818174902_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\565-textsearch-mapping\supabase\migrations\20260818174902_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="565-textsearch-mapping" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="565-textsearch-mapping" engine="next" command="sync-verification" status="OK" -->
...
### `20260818175031_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\565-textsearch-mapping-legacy\supabase\migrations\20260818175031_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="565-textsearch-mapping" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="565-textsearch-mapping" engine="legacy" command="sync-verification" status="OK" -->
