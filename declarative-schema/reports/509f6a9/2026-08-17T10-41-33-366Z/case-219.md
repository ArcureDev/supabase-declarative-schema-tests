...
### `20260817193450_219_rls_policy_hardening_baseline.sql`
...
### `20260817193531_declarative_sync.sql`
...
Applying migration 20260817193450_219_rls_policy_hardening_baseline.sql...
Initialising schema...
+ ulimit -n
+ '[' -n '' ']'
+ export ERL_CRASH_DUMP=/tmp/erl_crash.dump
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\219-rls-policy-hardening\supabase\migrations\20260817193531_declarative_sync.sql
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\219-rls-policy-hardening-legacy\supabase\migrations\20260817193647_219_rls_policy_hardening_baseline.sql
...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\219-rls-policy-hardening-legacy\supabase\.temp\pgdelta\debug\20260817-193648-apply-error
...
```text
The declarative baseline failed, so the strengthen an update policy in place while preserving populated data transition was skipped.
```
<!-- declarative-schema-command-result case="219-rls-policy-hardening" engine="legacy" command="sync" status="ERROR" -->
