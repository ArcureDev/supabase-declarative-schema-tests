# Case: 423-index-concurrent

- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `index-concurrent`
- Catalogue atoms: `PG-CAT-CIX-07::index.concurrent`

## Baseline state A

```sql
-- Covers PG-CAT-CIX-07::index.concurrent. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for index.concurrent must be refused, not silently omitted.
```
...
### `20260818110416_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\423-index-concurrent\supabase\migrations\20260818110416_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="423-index-concurrent" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="423-index-concurrent" engine="next" command="sync-verification" status="OK" -->
...
### `20260818110534_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\423-index-concurrent-legacy\supabase\migrations\20260818110534_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="423-index-concurrent" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="423-index-concurrent" engine="legacy" command="sync-verification" status="OK" -->
