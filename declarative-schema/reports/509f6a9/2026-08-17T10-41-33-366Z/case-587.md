# Case: 587-fdw-import-schema

- Scenario pack: `Extensions, FDWs, and external boundaries catalogue scenarios` / `fdw-import-schema`
- Catalogue atoms: `PG-CAT-EXT-05::fdw.import-schema`

## Baseline state A

```sql
-- Covers PG-CAT-EXT-05::fdw.import-schema. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for fdw.import-schema must be refused, not silently omitted.
```
...
### `20260818185002_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\587-fdw-import-schema\supabase\migrations\20260818185002_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="587-fdw-import-schema" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="587-fdw-import-schema" engine="next" command="sync-verification" status="OK" -->
...
### `20260818185121_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\587-fdw-import-schema-legacy\supabase\migrations\20260818185121_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="587-fdw-import-schema" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="587-fdw-import-schema" engine="legacy" command="sync-verification" status="OK" -->
