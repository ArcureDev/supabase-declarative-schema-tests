...
### `20260817175042_203_index_constraint_linkage_baseline.sql`
...
### `20260817175141_declarative_sync.sql`
...
Applying migration 20260817175042_203_index_constraint_linkage_baseline.sql...
Initialising schema...
+ ulimit -n
+ '[' -n '' ']'
+ export ERL_CRASH_DUMP=/tmp/erl_crash.dump
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\203-index-constraint-linkage\supabase\migrations\20260817175141_declarative_sync.sql
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\203-index-constraint-linkage-legacy\supabase\migrations\20260817175258_203_index_constraint_linkage_baseline.sql
...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\203-index-constraint-linkage-legacy\supabase\.temp\pgdelta\debug\20260817-175258-apply-error
...
```text
The declarative baseline failed, so the attach an existing unique index as a constraint and replace a constraint with a standalone index transition was skipped.
```
