# Case: 300-rename-schema

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `rename-schema`
- Catalogue atoms: `PG-CAT-STC-01::rename.schema`

## Baseline state A

```sql
-- Covers PG-CAT-STC-01::rename.schema. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818015256_rename_ambiguity_baseline.sql`
...
### `20260818015337_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.6s`
<!-- declarative-schema-command-result case="300-rename-schema" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="300-rename-schema" engine="next" command="sync-verification" status="OK" -->
