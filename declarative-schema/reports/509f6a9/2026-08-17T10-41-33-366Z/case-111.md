...
Debug information saved to E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\111-schema-authorization\supabase\.temp\pgdelta\debug\20260817-143344
...
Declarative schema planning failed: shadow load stuck after 2 round(s): 1 file(s) cannot apply
  - 00__fixture_authorized/schema.sql: role "fixture_schema_owner" does not exist (failed identically in 2 round(s) — likely a genuine missing dependency, not ordering)
```
