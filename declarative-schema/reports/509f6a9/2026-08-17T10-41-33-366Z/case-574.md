# Case: 574-language-trusted

- Scenario pack: `Text search, collations, conversions, and languages catalogue scenarios` / `language-trusted`
- Catalogue atoms: `PG-CAT-FTS-04::language.trusted`

## Baseline state A

```sql
-- Covers PG-CAT-FTS-04::language.trusted. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for language.trusted must be refused, not silently omitted.
```
...
### `20260818181314_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\574-language-trusted\supabase\migrations\20260818181314_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="574-language-trusted" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="574-language-trusted" engine="next" command="sync-verification" status="OK" -->
...
### `20260818181432_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\574-language-trusted-legacy\supabase\migrations\20260818181432_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="574-language-trusted" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="574-language-trusted" engine="legacy" command="sync-verification" status="OK" -->
