# Case: 549-policy-rename

- Scenario pack: `Roles, ownership, grants, and row-level security catalogue scenarios` / `policy-rename`
- Catalogue atoms: `PG-CAT-ROL-05::policy.rename`

## Baseline state A

```sql
-- Covers PG-CAT-ROL-05::policy.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818170304_rename_ambiguity_baseline.sql`
...
### `20260818170345_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.5s`
<!-- declarative-schema-command-result case="549-policy-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="549-policy-rename" engine="next" command="sync-verification" status="OK" -->
