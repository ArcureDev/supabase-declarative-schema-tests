# Case: 466-enum-delete-value

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `enum-delete-value`
- Catalogue atoms: `PG-CAT-TYP-01::enum.delete-value`
...
### `20260818130510_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\466-enum-delete-value\supabase\migrations\20260818130510_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="466-enum-delete-value" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="466-enum-delete-value" engine="next" command="sync-verification" status="OK" -->
...
### `20260818130639_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\466-enum-delete-value-legacy\supabase\migrations\20260818130639_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="466-enum-delete-value" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="466-enum-delete-value" engine="legacy" command="sync-verification" status="OK" -->
