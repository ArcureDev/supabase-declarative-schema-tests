...
- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `index-move`
- Catalogue atoms: `PG-CAT-CIX-05::index.move`
...
### `20260818102037_rename_ambiguity_baseline.sql`
...
### `20260818102138_declarative_sync.sql`
...
- Result: **OK**
- Duration: `60.3s`
<!-- declarative-schema-command-result case="408-index-move" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="408-index-move" engine="next" command="sync-verification" status="OK" -->
