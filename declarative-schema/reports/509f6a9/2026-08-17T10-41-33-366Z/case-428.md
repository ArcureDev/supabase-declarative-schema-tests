# Case: 428-statistics-create

- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `statistics-create`
- Catalogue atoms: `PG-CAT-CIX-08::statistics.create`

## Baseline state A

```sql
-- Covers PG-CAT-CIX-08::statistics.create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for statistics.create must be refused, not silently omitted.
```
...
### `20260818111746_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\428-statistics-create\supabase\migrations\20260818111746_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="428-statistics-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="428-statistics-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260818111924_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\428-statistics-create-legacy\supabase\migrations\20260818111924_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="428-statistics-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="428-statistics-create" engine="legacy" command="sync-verification" status="OK" -->
