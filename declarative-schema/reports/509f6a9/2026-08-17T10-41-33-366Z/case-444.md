# Case: 444-partition-rename

- Scenario pack: `Partitions and inheritance catalogue scenarios` / `partition-rename`
- Catalogue atoms: `PG-CAT-PRT-02::partition.rename`

## Baseline state A

```sql
-- Covers PG-CAT-PRT-02::partition.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260818120445_rename_ambiguity_baseline.sql`
...
### `20260818120526_declarative_sync.sql`
...
- Result: **OK**
- Duration: `40.0s`
<!-- declarative-schema-command-result case="444-partition-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="444-partition-rename" engine="next" command="sync-verification" status="OK" -->
