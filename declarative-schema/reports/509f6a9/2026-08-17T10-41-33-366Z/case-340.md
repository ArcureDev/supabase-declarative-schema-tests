# Case: 340-notnull-add-invalid

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `notnull-add-invalid`
- Catalogue atoms: `PG-CAT-STC-06::notnull.add.invalid`

## Baseline state A

```sql
-- Covers PG-CAT-STC-06::notnull.add.invalid. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for notnull.add.invalid must be refused, not silently omitted.
```
...
### `20260818055142_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\340-notnull-add-invalid\supabase\migrations\20260818055142_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="340-notnull-add-invalid" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="340-notnull-add-invalid" engine="next" command="sync-verification" status="OK" -->
...
### `20260818055312_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\340-notnull-add-invalid-legacy\supabase\migrations\20260818055312_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="340-notnull-add-invalid" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="340-notnull-add-invalid" engine="legacy" command="sync-verification" status="OK" -->
