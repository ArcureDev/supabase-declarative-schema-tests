# Case: 321-reorder-column

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `reorder-column`
- Catalogue atoms: `PG-CAT-STC-03::reorder.column`

## Baseline state A

```sql
-- Covers PG-CAT-STC-03::reorder.column. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for reorder.column must be refused, not silently omitted.
```
...
### `20260818035133_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\321-reorder-column\supabase\migrations\20260818035133_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="321-reorder-column" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="321-reorder-column" engine="next" command="sync-verification" status="OK" -->
...
### `20260818035253_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-bCM1EI\321-reorder-column-legacy\supabase\migrations\20260818035253_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="321-reorder-column" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="321-reorder-column" engine="legacy" command="sync-verification" status="OK" -->
