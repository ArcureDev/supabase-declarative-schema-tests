# Case: 599-boundary-superuser

- Scenario pack: `Explicit PostgreSQL boundaries catalogue scenarios` / `boundary-superuser`
- Catalogue atoms: `PG-CAT-BND-04::boundary.superuser`
...
### `20260816053218_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\599-boundary-superuser\supabase\migrations\20260816053218_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="599-boundary-superuser" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="599-boundary-superuser" engine="next" command="sync-verification" status="OK" -->
...
### `20260816053311_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\599-boundary-superuser-legacy\supabase\migrations\20260816053311_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="599-boundary-superuser" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="599-boundary-superuser" engine="legacy" command="sync-verification" status="OK" -->
