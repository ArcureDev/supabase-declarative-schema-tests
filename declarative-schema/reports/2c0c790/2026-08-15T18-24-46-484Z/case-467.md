# Case: 467-enum-reorder

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `enum-reorder`
- Catalogue atoms: `PG-CAT-TYP-01::enum.reorder`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-01::enum.reorder. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for enum.reorder must be refused, not silently omitted.
```
...
### `20260815232815_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\467-enum-reorder\supabase\migrations\20260815232815_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="467-enum-reorder" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="467-enum-reorder" engine="next" command="sync-verification" status="OK" -->
...
### `20260815232908_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\467-enum-reorder-legacy\supabase\migrations\20260815232908_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="467-enum-reorder" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="467-enum-reorder" engine="legacy" command="sync-verification" status="OK" -->
