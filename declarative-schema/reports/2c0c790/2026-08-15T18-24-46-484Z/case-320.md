# Case: 320-rename-column

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `rename-column`
- Catalogue atoms: `PG-CAT-STC-03::rename.column`

## Baseline state A

```sql
-- Covers PG-CAT-STC-03::rename.column. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260815185337_rename_ambiguity_baseline.sql`
...
### `20260815185352_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.0s`
<!-- declarative-schema-command-result case="320-rename-column" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="320-rename-column" engine="next" command="sync-verification" status="OK" -->
