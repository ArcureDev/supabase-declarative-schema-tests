# Case: 465-enum-rename-value

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `enum-rename-value`
- Catalogue atoms: `PG-CAT-TYP-01::enum.rename-value`
...
### `20260815232532_rename_ambiguity_baseline.sql`
...
### `20260815232546_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.3s`
<!-- declarative-schema-command-result case="465-enum-rename-value" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="465-enum-rename-value" engine="next" command="sync-verification" status="OK" -->
