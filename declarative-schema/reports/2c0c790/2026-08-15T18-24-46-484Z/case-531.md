# Case: 531-role-rename

- Scenario pack: `Roles, ownership, grants, and row-level security catalogue scenarios` / `role-rename`
- Catalogue atoms: `PG-CAT-ROL-01::role.rename`

## Baseline state A

```sql
-- Covers PG-CAT-ROL-01::role.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260816025634_rename_ambiguity_baseline.sql`
...
### `20260816025648_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.3s`
<!-- declarative-schema-command-result case="531-role-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="531-role-rename" engine="next" command="sync-verification" status="OK" -->
