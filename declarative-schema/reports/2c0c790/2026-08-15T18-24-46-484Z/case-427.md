# Case: 427-index-duplicate

- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `index-duplicate`
- Catalogue atoms: `PG-CAT-CIX-07::index.duplicate`

## Baseline state A

```sql
-- Covers PG-CAT-CIX-07::index.duplicate. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for index.duplicate must be refused, not silently omitted.
```
...
### `20260815213157_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\427-index-duplicate\supabase\migrations\20260815213157_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="427-index-duplicate" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="427-index-duplicate" engine="next" command="sync-verification" status="OK" -->
...
### `20260815213249_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\427-index-duplicate-legacy\supabase\migrations\20260815213249_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="427-index-duplicate" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="427-index-duplicate" engine="legacy" command="sync-verification" status="OK" -->
