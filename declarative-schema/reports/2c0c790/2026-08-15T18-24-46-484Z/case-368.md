# Case: 368-access-method

- Scenario pack: `Schemas, tables, columns, and sequences catalogue scenarios` / `access-method`
- Catalogue atoms: `PG-CAT-STC-10::access-method`

## Baseline state A

```sql
-- Covers PG-CAT-STC-10::access-method. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for access-method must be refused, not silently omitted.
```
...
### `20260815201540_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\368-access-method\supabase\migrations\20260815201540_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="368-access-method" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="368-access-method" engine="next" command="sync-verification" status="OK" -->
...
### `20260815201633_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\368-access-method-legacy\supabase\migrations\20260815201633_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="368-access-method" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="368-access-method" engine="legacy" command="sync-verification" status="OK" -->
