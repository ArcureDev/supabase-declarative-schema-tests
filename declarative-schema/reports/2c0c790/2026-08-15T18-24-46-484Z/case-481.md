...
### `20260815234709_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\481-cast-drop\supabase\migrations\20260815234709_declarative_sync.sql
...
- Assertion: **ERROR**
- The unsupported capability did not satisfy its diagnostic contract. Missing diagnostic(s): reports a stable capability or scope diagnostic.
