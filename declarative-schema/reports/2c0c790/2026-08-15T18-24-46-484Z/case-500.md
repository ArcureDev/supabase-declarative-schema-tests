# Case: 500-matview-refresh

- Scenario pack: `Views and materialized views catalogue scenarios` / `matview-refresh`
- Catalogue atoms: `PG-CAT-VIW-04::matview.refresh`

## Baseline state A

```sql
-- Covers PG-CAT-VIW-04::matview.refresh. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for matview.refresh must be refused, not silently omitted.
```
...
### `20260816011336_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\500-matview-refresh\supabase\migrations\20260816011336_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="500-matview-refresh" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="500-matview-refresh" engine="next" command="sync-verification" status="OK" -->
...
### `20260816011428_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\500-matview-refresh-legacy\supabase\migrations\20260816011428_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="500-matview-refresh" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="500-matview-refresh" engine="legacy" command="sync-verification" status="OK" -->
