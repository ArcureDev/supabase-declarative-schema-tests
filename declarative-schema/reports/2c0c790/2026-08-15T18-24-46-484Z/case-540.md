# Case: 540-grant-parameter

- Scenario pack: `Roles, ownership, grants, and row-level security catalogue scenarios` / `grant-parameter`
- Catalogue atoms: `PG-CAT-ROL-03::grant.parameter`
...
### `20260816030922_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\540-grant-parameter\supabase\migrations\20260816030922_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="540-grant-parameter" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="540-grant-parameter" engine="next" command="sync-verification" status="OK" -->
...
### `20260816031015_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\540-grant-parameter-legacy\supabase\migrations\20260816031015_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="540-grant-parameter" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="540-grant-parameter" engine="legacy" command="sync-verification" status="OK" -->
