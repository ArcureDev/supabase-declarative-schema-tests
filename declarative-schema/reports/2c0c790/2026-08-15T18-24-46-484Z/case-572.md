# Case: 572-conversion-rename

- Scenario pack: `Text search, collations, conversions, and languages catalogue scenarios` / `conversion-rename`
- Catalogue atoms: `PG-CAT-FTS-03::conversion.rename`

## Baseline state A

```sql
-- Covers PG-CAT-FTS-03::conversion.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260816045221_rename_ambiguity_baseline.sql`
...
### `20260816045235_declarative_sync.sql`
...
- Result: **OK**
- Duration: `13.8s`
<!-- declarative-schema-command-result case="572-conversion-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="572-conversion-rename" engine="next" command="sync-verification" status="OK" -->
