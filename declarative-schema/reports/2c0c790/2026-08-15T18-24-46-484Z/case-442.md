# Case: 442-partition-finalize-detach

- Scenario pack: `Partitions and inheritance catalogue scenarios` / `partition-finalize-detach`
- Catalogue atoms: `PG-CAT-PRT-02::partition.finalize-detach`

## Baseline state A

```sql
-- Covers PG-CAT-PRT-02::partition.finalize-detach. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for partition.finalize-detach must be refused, not silently omitted.
```
...
### `20260815225524_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\442-partition-finalize-detach\supabase\migrations\20260815225524_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="442-partition-finalize-detach" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="442-partition-finalize-detach" engine="next" command="sync-verification" status="OK" -->
...
### `20260815225617_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\442-partition-finalize-detach-legacy\supabase\migrations\20260815225617_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="442-partition-finalize-detach" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="442-partition-finalize-detach" engine="legacy" command="sync-verification" status="OK" -->
