# Case: 507-routine-rename

- Scenario pack: `Functions, procedures, aggregates, and triggers catalogue scenarios` / `routine-rename`
- Catalogue atoms: `PG-CAT-RTN-02::routine.rename`

## Baseline state A

```sql
-- Covers PG-CAT-RTN-02::routine.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260816012337_rename_ambiguity_baseline.sql`
...
### `20260816012351_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.2s`
<!-- declarative-schema-command-result case="507-routine-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="507-routine-rename" engine="next" command="sync-verification" status="OK" -->
