...
### `20260815230258_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\448-partition-key\supabase\migrations\20260815230258_declarative_sync.sql
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="448-partition-key" engine="next" command="sync-verification" status="OK" -->
...
### `20260815230351_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\448-partition-key-legacy\supabase\migrations\20260815230351_declarative_sync.sql
