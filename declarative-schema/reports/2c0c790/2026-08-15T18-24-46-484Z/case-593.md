# Case: 593-boundary-database-create

- Scenario pack: `Explicit PostgreSQL boundaries catalogue scenarios` / `boundary-database-create`
- Catalogue atoms: `PG-CAT-BND-02::boundary.database-create`

## Baseline state A

```sql
-- Covers PG-CAT-BND-02::boundary.database-create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for boundary.database-create must be refused, not silently omitted.
```
...
### `20260816052215_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\593-boundary-database-create\supabase\migrations\20260816052215_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="593-boundary-database-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="593-boundary-database-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260816052308_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\593-boundary-database-create-legacy\supabase\migrations\20260816052308_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="593-boundary-database-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="593-boundary-database-create" engine="legacy" command="sync-verification" status="OK" -->
