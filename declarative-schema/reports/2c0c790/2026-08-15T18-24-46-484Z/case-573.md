# Case: 573-language-create

- Scenario pack: `Text search, collations, conversions, and languages catalogue scenarios` / `language-create`
- Catalogue atoms: `PG-CAT-FTS-04::language.create`

## Baseline state A

```sql
-- Covers PG-CAT-FTS-04::language.create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for language.create must be refused, not silently omitted.
```
...
### `20260816045323_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\573-language-create\supabase\migrations\20260816045323_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="573-language-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="573-language-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260816045416_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\573-language-create-legacy\supabase\migrations\20260816045416_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="573-language-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="573-language-create" engine="legacy" command="sync-verification" status="OK" -->
