# Case: 568-collation-rename

- Scenario pack: `Text search, collations, conversions, and languages catalogue scenarios` / `collation-rename`
- Catalogue atoms: `PG-CAT-FTS-02::collation.rename`

## Baseline state A

```sql
-- Covers PG-CAT-FTS-02::collation.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260816034626_rename_ambiguity_baseline.sql`
...
### `20260816034640_declarative_sync.sql`
...
- Result: **OK**
- Duration: `13.8s`
<!-- declarative-schema-command-result case="568-collation-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="568-collation-rename" engine="next" command="sync-verification" status="OK" -->
