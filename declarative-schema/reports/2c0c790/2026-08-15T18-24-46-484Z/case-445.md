# Case: 445-partition-move

- Scenario pack: `Partitions and inheritance catalogue scenarios` / `partition-move`
- Catalogue atoms: `PG-CAT-PRT-02::partition.move`

## Baseline state A

```sql
-- Covers PG-CAT-PRT-02::partition.move. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260815225925_rename_ambiguity_baseline.sql`
...
### `20260815225939_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.0s`
<!-- declarative-schema-command-result case="445-partition-move" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="445-partition-move" engine="next" command="sync-verification" status="OK" -->
