# Case: 451-partition-attach-invalid

- Scenario pack: `Partitions and inheritance catalogue scenarios` / `partition-attach-invalid`
- Catalogue atoms: `PG-CAT-PRT-04::partition.attach-invalid`
...
### `20260815230734_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\451-partition-attach-invalid\supabase\migrations\20260815230734_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="451-partition-attach-invalid" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="451-partition-attach-invalid" engine="next" command="sync-verification" status="OK" -->
...
### `20260815230827_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\451-partition-attach-invalid-legacy\supabase\migrations\20260815230827_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="451-partition-attach-invalid" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="451-partition-attach-invalid" engine="legacy" command="sync-verification" status="OK" -->
