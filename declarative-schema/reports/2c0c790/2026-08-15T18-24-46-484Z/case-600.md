# Case: 600-boundary-stable-diagnostic

- Scenario pack: `Explicit PostgreSQL boundaries catalogue scenarios` / `boundary-stable-diagnostic`
- Catalogue atoms: `PG-CAT-BND-05::boundary.stable-diagnostic`

## Baseline state A

```sql
-- Covers PG-CAT-BND-05::boundary.stable-diagnostic. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for boundary.stable-diagnostic must be refused, not silently omitted.
```
...
### `20260816053358_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\600-boundary-stable-diagnostic\supabase\migrations\20260816053358_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="600-boundary-stable-diagnostic" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="600-boundary-stable-diagnostic" engine="next" command="sync-verification" status="OK" -->
...
### `20260816053451_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\600-boundary-stable-diagnostic-legacy\supabase\migrations\20260816053451_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="600-boundary-stable-diagnostic" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="600-boundary-stable-diagnostic" engine="legacy" command="sync-verification" status="OK" -->
