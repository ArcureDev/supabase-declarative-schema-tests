# Case: 430-statistics-rename

- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `statistics-rename`
- Catalogue atoms: `PG-CAT-CIX-08::statistics.rename`

## Baseline state A

```sql
-- Covers PG-CAT-CIX-08::statistics.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260815213657_rename_ambiguity_baseline.sql`
...
### `20260815213711_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.1s`
<!-- declarative-schema-command-result case="430-statistics-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="430-statistics-rename" engine="next" command="sync-verification" status="OK" -->
