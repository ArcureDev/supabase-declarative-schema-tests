# Case: 463-enum-rename

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `enum-rename`
- Catalogue atoms: `PG-CAT-TYP-01::enum.rename`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-01::enum.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260815232314_rename_ambiguity_baseline.sql`
...
### `20260815232329_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.2s`
<!-- declarative-schema-command-result case="463-enum-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="463-enum-rename" engine="next" command="sync-verification" status="OK" -->
