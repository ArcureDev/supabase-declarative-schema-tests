# Case: 590-boundary-access-method

- Scenario pack: `Explicit PostgreSQL boundaries catalogue scenarios` / `boundary-access-method`
- Catalogue atoms: `PG-CAT-BND-01::boundary.access-method`
...
### `20260816051714_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\590-boundary-access-method\supabase\migrations\20260816051714_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="590-boundary-access-method" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="590-boundary-access-method" engine="next" command="sync-verification" status="OK" -->
...
### `20260816051807_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\590-boundary-access-method-legacy\supabase\migrations\20260816051807_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="590-boundary-access-method" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="590-boundary-access-method" engine="legacy" command="sync-verification" status="OK" -->
