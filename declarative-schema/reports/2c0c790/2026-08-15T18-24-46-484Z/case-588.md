# Case: 588-seclabel-create

- Scenario pack: `Extensions, FDWs, and external boundaries catalogue scenarios` / `seclabel-create`
- Catalogue atoms: `PG-CAT-EXT-06::seclabel.create`

## Baseline state A

```sql
-- Covers PG-CAT-EXT-06::seclabel.create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for seclabel.create must be refused, not silently omitted.
```
...
### `20260816051356_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\588-seclabel-create\supabase\migrations\20260816051356_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="588-seclabel-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="588-seclabel-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260816051448_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\588-seclabel-create-legacy\supabase\migrations\20260816051448_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="588-seclabel-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="588-seclabel-create" engine="legacy" command="sync-verification" status="OK" -->
