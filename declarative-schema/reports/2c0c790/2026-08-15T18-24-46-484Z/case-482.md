# Case: 482-operator-create

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `operator-create`
- Catalogue atoms: `PG-CAT-TYP-07::operator.create`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-07::operator.create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for operator.create must be refused, not silently omitted.
```
...
### `20260816004914_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\482-operator-create\supabase\migrations\20260816004914_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="482-operator-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="482-operator-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260816005008_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\482-operator-create-legacy\supabase\migrations\20260816005008_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="482-operator-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="482-operator-create" engine="legacy" command="sync-verification" status="OK" -->
