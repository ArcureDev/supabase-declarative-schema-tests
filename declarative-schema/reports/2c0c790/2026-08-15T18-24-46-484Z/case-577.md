# Case: 577-extension-upgrade

- Scenario pack: `Extensions, FDWs, and external boundaries catalogue scenarios` / `extension-upgrade`
- Catalogue atoms: `PG-CAT-EXT-01::extension.upgrade`

## Baseline state A

```sql
-- Covers PG-CAT-EXT-01::extension.upgrade. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for extension.upgrade must be refused, not silently omitted.
```
...
### `20260816045942_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\577-extension-upgrade\supabase\migrations\20260816045942_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="577-extension-upgrade" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="577-extension-upgrade" engine="next" command="sync-verification" status="OK" -->
...
### `20260816050034_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\577-extension-upgrade-legacy\supabase\migrations\20260816050034_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="577-extension-upgrade" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.3s`
<!-- declarative-schema-command-result case="577-extension-upgrade" engine="legacy" command="sync-verification" status="OK" -->
