...
### `20260815190237_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\327-cast-lossy\supabase\migrations\20260815190237_declarative_sync.sql
Generated migration SQL:
create table "public"."catalogue_probe" (
  "id"    bigint not null,
  "label" text,
...
### `20260815190329_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\327-cast-lossy-legacy\supabase\migrations\20260815190329_declarative_sync.sql
