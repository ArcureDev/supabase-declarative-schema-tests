# Case: 478-base-type-create

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `base-type-create`
- Catalogue atoms: `PG-CAT-TYP-05::base-type.create`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-05::base-type.create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for base-type.create must be refused, not silently omitted.
```
...
### `20260815234210_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\478-base-type-create\supabase\migrations\20260815234210_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="478-base-type-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="478-base-type-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260815234303_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\478-base-type-create-legacy\supabase\migrations\20260815234303_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="478-base-type-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="478-base-type-create" engine="legacy" command="sync-verification" status="OK" -->
