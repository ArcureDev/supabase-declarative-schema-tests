# Case: 485-transform-create

- Scenario pack: `Types, domains, ranges, and casts catalogue scenarios` / `transform-create`
- Catalogue atoms: `PG-CAT-TYP-08::transform.create`

## Baseline state A

```sql
-- Covers PG-CAT-TYP-08::transform.create. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for transform.create must be refused, not silently omitted.
```
...
### `20260816005327_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\485-transform-create\supabase\migrations\20260816005327_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="485-transform-create" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="485-transform-create" engine="next" command="sync-verification" status="OK" -->
...
### `20260816005420_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\485-transform-create-legacy\supabase\migrations\20260816005420_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="485-transform-create" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="485-transform-create" engine="legacy" command="sync-verification" status="OK" -->
