# Case: 592-boundary-database-settings

- Scenario pack: `Explicit PostgreSQL boundaries catalogue scenarios` / `boundary-database-settings`
- Catalogue atoms: `PG-CAT-BND-01::boundary.database-settings`
...
### `20260816052034_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\592-boundary-database-settings\supabase\migrations\20260816052034_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="592-boundary-database-settings" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="592-boundary-database-settings" engine="next" command="sync-verification" status="OK" -->
...
### `20260816052128_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\592-boundary-database-settings-legacy\supabase\migrations\20260816052128_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="592-boundary-database-settings" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="592-boundary-database-settings" engine="legacy" command="sync-verification" status="OK" -->
