# Case: 407-index-rename

- Scenario pack: `Constraints, indexes, statistics, and rules catalogue scenarios` / `index-rename`
- Catalogue atoms: `PG-CAT-CIX-05::index.rename`

## Baseline state A

```sql
-- Covers PG-CAT-CIX-05::index.rename. Keep public.transition_anchor identity stable. PostgreSQL RENAME/SET SCHEMA preserves OIDs; an unhinted declarative pair must not silently drop data.
...
### `20260815210614_rename_ambiguity_baseline.sql`
...
### `20260815210628_declarative_sync.sql`
...
- Result: **OK**
- Duration: `14.2s`
<!-- declarative-schema-command-result case="407-index-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="407-index-rename" engine="next" command="sync-verification" status="OK" -->
