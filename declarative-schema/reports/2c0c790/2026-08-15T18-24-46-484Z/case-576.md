# Case: 576-extension-drop

- Scenario pack: `Extensions, FDWs, and external boundaries catalogue scenarios` / `extension-drop`
- Catalogue atoms: `PG-CAT-EXT-01::extension.drop`

## Baseline state A

```sql
-- Covers PG-CAT-EXT-01::extension.drop. Keep public.transition_anchor identity stable. This atom is an explicit supported/unsupported boundary, not an accidental omission.
...
-- Desired change for extension.drop must be refused, not silently omitted.
```
...
### `20260816045759_declarative_sync.sql`
...
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\576-extension-drop\supabase\migrations\20260816045759_declarative_sync.sql
...
grant maintain, references, trigger, truncate on table "public"."transition_anchor" to "service_role";
```
<!-- declarative-schema-command-result case="576-extension-drop" engine="next" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="576-extension-drop" engine="next" command="sync-verification" status="OK" -->
...
### `20260816045854_declarative_sync.sql`
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
Created new migration at E:\workspace\supabase-declarative-schema-tests\declarative-schema\.tmp\run-DHzNgi\576-extension-drop-legacy\supabase\migrations\20260816045854_declarative_sync.sql
...
GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON public.transition_anchor TO service_role;
```
<!-- declarative-schema-command-result case="576-extension-drop" engine="legacy" command="sync" status="ERROR" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="576-extension-drop" engine="legacy" command="sync-verification" status="OK" -->
