# Case: 584-server-rename

- Scenario pack: `Extensions, FDWs, and external boundaries catalogue scenarios` / `server-rename`
- Catalogue atoms: `PG-CAT-EXT-03::server.rename`
...
### `20260816050914_rename_ambiguity_baseline.sql`
...
### `20260816050928_declarative_sync.sql`
...
- Result: **OK**
- Duration: `13.8s`
<!-- declarative-schema-command-result case="584-server-rename" engine="next" command="sync" status="OK" -->
...
- Result: **OK**
- Duration: `0.1s`
<!-- declarative-schema-command-result case="584-server-rename" engine="next" command="sync-verification" status="OK" -->
